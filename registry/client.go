...
func RegisterService(r Registration) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("faild to register service. Registry service responed with code %v", res.StatusCode)
	}
	return nil
}
...
func ShutdownService(url string) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("failed to deregister service %s.Registry service responded with code %v", url, res.StatusCode)
	}
	return nil
}
